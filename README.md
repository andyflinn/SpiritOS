...
**A 1 GB VPS with 10 GB of disc holds live connections for about 16,000 members.**
...
Measured on `ubuntu-24.04-wsl2` at `27374ee`, 2026-09-21: 63 MB resident at rest, 52,091 bytes a held connection, 197 bytes a member on disc. Allowing 150 MB for the operating system and web server, which is the one estimated figure here. Disc is nowhere near binding: 10 GB would store 54.5 million rows. **Taken under WSL**, which is the same distribution and runtime but a workstation rather than a VPS; bare-metal figures replace these automatically once such a box publishes.
