...
if (isNode()) {
  ...
  const UNSERVABLE_FILES = ['js/kernel.js', 'js/jobs.js', 'js/server.js', 'js/relayServer.js', 'js/serveCommon.js', 'js/relayConfig.js', 'js/relay.js', 'js/hub.js', 'js/relayAuth.js'];
